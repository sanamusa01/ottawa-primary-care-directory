...
<div id="ottrx-root" class="ottrx ottrx--wordpress" lang="<?php echo esc_attr( $directory_language ); ?>" data-data-url="<?php echo esc_url( $directory_data_url ); ?>" data-leaflet-css="<?php echo esc_url( $leaflet_css_url ); ?>" data-leaflet-js="<?php echo esc_url( $leaflet_js_url ); ?>" aria-busy="true">
  ...
  <div class="ottrx__bar">
    ...
    <div class="ottrx__tabs" role="tablist" aria-label="Directory sections" data-tabs=""><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-all" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="all">Search everything</button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-referral" aria-controls="ottrx-panel" aria-selected="true" tabindex="0" data-tab="referral">Referral routes</button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-map" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="map">Map</button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-specialists" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="specialists">Specialists <span class="n">785</span></button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-services" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="services">Clinics &amp; services <span class="n">2217</span></button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-fax" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="fax">Fax lookup <span class="n">1156</span></button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-forms" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="forms">Forms</button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-resources" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="resources">Resources</button><button type="button" class="ottrx__tab" role="tab" id="ottrx-tab-quick" aria-controls="ottrx-panel" aria-selected="false" tabindex="-1" data-tab="quick">Quick numbers</button></div>
  </div>
